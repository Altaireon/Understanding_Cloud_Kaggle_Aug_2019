...
with open('params/cloud-6.json') as f:
    params = json.loads(f.read())
    f.close()

logfile = params['LOG_DIR'] + params['name'] + '-' + params['id'] + '.log'
...
#train.process_kfold_train_classification()

pop = PostProcess(params,rle_encoding,rle_decoding,loader.names)
